...
class GUI :
    ...
    def __init__(self):
        ...
        self.current_board = Temp_board.level[0]
    ...
    '''    
    Purpose input_level() input the level_board to the current_board
    effect: modify sudoku_entry()
    '''
    ...
    '''
    Purpose: delay_five_second is used after finish a level, delay and then do the next step
    effect: effect output
    '''
    def delay_second(self, second):
        pass
